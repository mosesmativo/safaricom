(function($) {
    ...
    =============================================*/
    const URL = '"https://isobar-1.smoxz.com/safaricomneo/';
    var windows = $(window);
...
jQuery(document).ready(function($){
  ...
  setTimeout(function(){
    ...
    $("#country").change(function(){
        ...
        select_box.empty();
        jQuery.ajax({
            url: "/safaricomneo/includes/api/continent.php",
            type:'POST',
            data:
            {
                id: id,
      ...
      function getrates(id,country){
        ...
        jQuery.ajax({
            url: "/safaricomneo/includes/api/getrates.php",
            type:'POST',
            data:
            {
                id: id,
    ...
    function getpref(id,country){
        ...
        jQuery.ajax({
            url: "/safaricomneo/includes/api/getpref.php",
            type:'POST',
            data:
            {
                id: id,
    ...
    $("#continent").change(function(){
        ...
        jQuery.ajax({
            url: "/safaricomneo/includes/api/country.php",
            type:'POST',
            data:
            {
                id: id,
    ...
    jQuery("#sms_select").keyup(function(){
     ...
     jQuery("#data_select").change(function(){
       ...
       jQuery.ajax({
           url: "/safaricomneo/includes/api/getbundles.php",
           type:'POST',
           data:
           {
               id: id2,
     ...
     jQuery("#mpesa_rates_select").change(function(){
       ...
       jQuery.ajax({
           url: "/safaricomneo/includes/api/mpesacalculator.php",
           type:'POST',
           data:
           {
               amount: min_amount,
     ...
     jQuery("#mpesa_rates_atm_select").change(function(){
       ...
       jQuery.ajax({
           url: "/safaricomneo/includes/api/getatmmpesarates.php",
           type:'POST',
           data:
           {
               amount: min_amount,
       ...
       jQuery.ajax({
           ...
           success: function(msg)
           {
             ...
             for (var i = 0; i < data.length; i++) {
               ...
               select_box.append(jQuery("<option />").val(data[i].id).text(data[i].country_name));
               select_box2.append(jQuery("<option />").val(data[i].id).text(data[i].country_name + ' (+' + data[i].phone_code + ')'));
    ...
    //    $('#country').select2();
       ...
       jQuery.ajax({
        url: "/safaricomneo/includes/api/getsms.php",
        type:'POST',
        success: function(msg)
        {
...
jQuery(".rapid_submit").click(function() {
    ...
    if(comment =="") {
        ...
        jQuery.ajax({
            url: "/safaricomneo/includes/api/comments.php",
            type:'POST',
            data:
           {
               comment: comment,
...
jQuery("#image_good").click(function() {
    ...
    jQuery.ajax({
        url: "/safaricomneo/includes/api/likes.php",
        type:'POST',
        success: function(msg)
        {
